  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-picture-o"></i> Layer - Style</h3>
      </div>
      <div class="modal-body">
        <form autocomplete="off" class="form-horizontal">
          <fieldset class="style" id="style0">
            ...
            <div class="form-group">
              <label for="inputStyle0Width" class="col-sm-3 control-label">Width</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputStyle0Width" name="style[0][width]">
              </div>
            </div>
            <div class="form-group">
              <label for="inputStyle0Symbol" class="col-sm-3 control-label">Symbol</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputStyle0Symbol" name="style[0][symbolname]">
              </div>
            </div>
            <div class="form-group">
              <label for="inputStyle0Size" class="col-sm-3 control-label">Size</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputStyle0Size" name="style[0][size]">
              </div>
            </div>
          </fieldset>
        </form>
