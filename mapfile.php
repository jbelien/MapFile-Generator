...
<div class="container">
  <form action="mapfile.php" method="post">
    ...
    <?php if (isset($_SESSION['mapfile-generator']['source'])) {
  echo '<p class="text-info">Source : <samp>'.$_SESSION['mapfile-generator']['source'].'</samp></p>';
}
?>
...
<div class="container">
  <div class="text-center">
    ...
    <?php if (isset($_SESSION['mapfile-generator']['source'])) {
  echo '<a id="mapfile-save" class="btn btn-primary" href="?map='.$_SESSION['mapfile-generator']['source'].'&amp;save"><i class="fa fa-floppy-o"></i> Save</a>';
}
?>
